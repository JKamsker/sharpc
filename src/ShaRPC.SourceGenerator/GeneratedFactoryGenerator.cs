...
internal static class GeneratedFactoryGenerator
{
    public static string Generate(EquatableArray<ServiceModel> services, CancellationToken ct = default)
    {
        ...
        sb.AppendLine("        /// </summary>");
        sb.AppendLine("        public static TService CreateProxy<TService>(global::ShaRPC.Core.IRpcInvoker invoker)");
        sb.AppendLine("            where TService : class");
        sb.AppendLine("            => global::ShaRPC.Core.Generated.ShaRpcServiceRegistry.CreateProxy<TService>(invoker);");
        sb.AppendLine();
        sb.AppendLine("        /// <summary>");
        sb.AppendLine("        /// Creates the generated proxy for <paramref name=\"serviceInterface\" /> over an invoker.");
        sb.AppendLine("        /// </summary>");
        sb.AppendLine("        public static object CreateProxy(global::System.Type serviceInterface, global::ShaRPC.Core.IRpcInvoker invoker)");
        sb.AppendLine("            => global::ShaRPC.Core.Generated.ShaRpcServiceRegistry.CreateProxy(serviceInterface, invoker);");
        sb.AppendLine();
        sb.AppendLine("        /// <summary>");
